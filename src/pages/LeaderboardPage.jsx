...
const LeaderboardPage = () => {
  const { playerStats, battleHistory, leaderboard } = useBattle();
  ...
  const currentEntries = sortedLeaderboard
  ...
  return (
    <div style={pageStyle}>
      ...
      <div style={sectionStyle}>
        <h2 style={{ marginBottom: '1rem', color: '#333' }}>Your Profile</h2>
        <div style={statsGridStyle}>
          <div style={statCardStyle}>
            <h3 style={{ marginBottom: '0.5rem', color: '#666' }}>Total Score</h3>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>
              {playerStats.score}
            </p>
          </div>
          <div style={statCardStyle}>
            <h3 style={{ marginBottom: '0.5rem', color: '#666' }}>Win Rate</h3>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>
              {playerStats.winRate.toFixed(1)}%
            </p>
          </div>
          <div style={statCardStyle}>
            <h3 style={{ marginBottom: '0.5rem', color: '#666' }}>Total Battles</h3>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>
              {playerStats.totalBattles}
            </p>
          </div>
          <div style={statCardStyle}>
            <h3 style={{ marginBottom: '0.5rem', color: '#666' }}>Wins/Losses</h3>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#333' }}>
      ...
      {/* Leaderboard Section */}
      <div style={sectionStyle}>
        <h2 style={{ marginBottom: '1rem', color: '#333' }}>Global Leaderboard</h2>
          ...
          <thead>
            <tr>
              <th 
                style={{
                  ...thStyle,
                  backgroundColor: sortBy === 'rank' ? '#e3f2fd' : thStyle.backgroundColor
                }} 
              ...
              <th 
                style={{
                  ...thStyle,
                  backgroundColor: sortBy === 'score' ? '#e3f2fd' : thStyle.backgroundColor
                }} 
              ...
              <th 
                style={{
                  ...thStyle,
                  backgroundColor: sortBy === 'winRate' ? '#e3f2fd' : thStyle.backgroundColor
                }} 
          ...
          <tbody>
            {currentEntries.map((entry) => (
              <tr 
                key={entry.playerId}
                style={{
                  backgroundColor: entry.playerId === playerStats.playerId ? '#e3f2fd' : 'transparent'
                }}
              >
      ...
      <div style={sectionStyle}>
        <h2 style={{ marginBottom: '1rem', color: '#333' }}>Recent Battles</h2>
        <table style={tableStyle}>
          <thead>
            <tr>
          ...
          <tbody>
            {battleHistory.slice(0, 10).map((battle, index) => (
              <tr key={index}>
                ...
                <td style={tdStyle}>
                  <span style={{
                    color: battle.result === 'win' ? '#28a745' : '#dc3545',
                    fontWeight: 'bold',
                  }}>
                ...
                <td style={tdStyle}>
                  <span style={{
                    ...
                    {battle.scoreChange > 0 ? '+' : ''}{battle.scoreChange}
                  </span>
                </td>
              </tr>
            ))}
